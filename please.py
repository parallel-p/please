...
if __name__ == "__main__":
    ...
    matcher.add_handler(Template(["generate", "statements", "@problem_names"]), latex_tools.generate_contest)
    ...
    if package_config:
        ...
        matcher.add_handler(Template(["set", "standard", "checker", "#checker"]), add_standard_checker_to_solution)
        ...
        matcher.add_handler(Template(["set", "checker", "#path"]), add_checker)
        matcher.add_handler(Template(["set", "main", "solution", "#path"]), add_main_solution)
        matcher.add_handler(Template(["set", "validator", "#path"]), add_validator)
