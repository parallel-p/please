...
urlpatterns = patterns('',
    ...
    (r'^contest', include('please.web.contest.urls')),
    ...
    url(r'^problems/(?P<id>\d+)/materials/statement/view/$', 'problem.views.materials.view_statement', name="view_statement"),
    ...
    url(r'^problems/(?P<id>\d+)/$', 'problem.views.problem.settings', name='problem'),
    ...
    url(r'^problems/copy_problem/$', 'problem.views.problems.copy_problem'),
)
